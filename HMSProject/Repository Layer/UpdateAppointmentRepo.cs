...
namespace HMSProject.Repository_Layer
{
    ...
    {
        public void Search(MetroGrid mgv, UpdateAppointmentEntity entity)
        {
        ...
        public void Update(UpdateAppointmentEntity en, MetroGrid mgv)
        {
        ...
        public void Delete(UpdateAppointmentEntity en)
        {
